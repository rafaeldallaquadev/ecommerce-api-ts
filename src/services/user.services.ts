...
import type { UserRow } from '../types/mysql.types.js';
...
export async function registerUser( data: RegisterUserDTO): Promise<SafeUser> {
...
export async function userLogin(data: LoginUserDTO): Promise<AuthResponse> {
